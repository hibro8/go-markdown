...
const en: Messages = {
  ...
  'settings.theme.light': 'GitHub Light',
  'settings.theme.dark': 'GitHub Dark',
...
const zh: Messages = {
  ...
  'settings.theme': '主题',
  'settings.theme.light': 'GitHub 亮色',
  'settings.theme.dark': 'GitHub 暗色',
  'settings.theme.solarizedLight': 'Solarized 亮色',
  'settings.theme.solarizedDark': 'Solarized 暗色',
  'settings.theme.dracula': 'Dracula',
  'settings.theme.nord': 'Nord',
  'settings.theme.oneDark': 'One Dark',
  'settings.theme.monokai': 'Monokai',
